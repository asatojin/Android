...
/*
 * Copyright (c) 2010-2011 OrangeSignal.com. All Rights Reserved.
...
//    private long significantlyNewer = 2 * 60 * 1000L;
     ...
     */
    public static final long DEFAULT_INTERVAL = 0 * 1000L;
     ...
     */
    public static final long DEFAULT_TIMEOUT = 0 * 1000L;
    ...
    private long minTime = 6 * 1000L;
    private float minDistance = 0 * 1;
...
//                    memeDataActivity.lat = location.getLatitude();
//                    memeDataActivity.lng = location.getLongitude();
                }
